...
```sh
echoctl wake install \
  --model-id okay_nabu-pyoww-6bc5c5f-20260820 \
  --kind openwakeword \
  --phrase "okay nabu" \
  --language en \
  --melspec .assets/wake-models/melspectrogram.tflite \
  --melspec-sha256 96fa0adccb6e8cf95cb14465409a1a2898ee4a96a85bb9ed3c7eb0e68bf163e8 \
  --embedding .assets/wake-models/embedding_model.tflite \
  --embedding-sha256 c0aea21eb84a4ce90a08c870da41b7a7173b45269e6a3207c71d67c40f3a59d8 \
  --classifier .assets/wake-models/okay_nabu.tflite \
  --classifier-sha256 2982cecde4ee81cc7a2573d2602a7d54f0669425c94a7b64af77e0ff92b03a18
```

After host-side installation, push the generated model directory to the Dot with
ADB or let the later gateway asset-sync milestone manage distribution. Do not
