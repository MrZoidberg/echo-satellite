...
type opts struct {
	...
	DiagnosticEvidence string `long:"diagnostic-evidence-dir" env:"GATEWAY_DIAGNOSTIC_EVIDENCE_DIR" description:"optional existing directory for sanitized diagnostic turn JSONL evidence"`
