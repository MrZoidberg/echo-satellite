...
// An empty slice never reaches the assembly, because taking the address of the
// first element of one panics. The reslice is what the Go implementations do
// too, and raises the same panic when the second slice is short.
